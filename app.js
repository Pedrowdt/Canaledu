...
function saveState() {
  ...
  //
  // NOTA (revertido em 2.8.1): um commit anterior (027f405) tentou
  // resolver aqui um relato de "peças somem ao sincronizar" com um
  // confirm() bloqueante + chamada a uma função loadState() inexistente
  // (quebrava a tela) — e removeu a chamada a registrarUndoSeMudou() logo
  // acima, desligando "Desfazer última ação" sem nenhum erro visível. O
  // bug relatado não tem raiz aqui: saveState() só grava o espelho local
  // do cadastro (localStorage), nunca escreve em public.pecas/programas —
  // a proteção real contra sobrescrita entre usuários já existe em
  // cloud-sync.js (RoteiroPecasBridge.mergeCadastro + temAlteracoesPendentes)
  // e em pecas-programas.js (mesmo padrão), ver comentários lá.
  //
...
const VH_SEGUIR_MAP = [
  { code: '85172', descricao: 'VH A SEGUIR IGARAPE MAGICO',                    tempo: '00:00:05', midia: '0OMN', type: 'EVNH', keywords: ['IGARAPE MAGICO', 'IGARAPÉ MÁGICO'] },
  { code: '90160', descricao: 'VH A SEGUIR LUPITA NO PLANETA DE GENTE GRANDE', tempo: '00:00:05', midia: '0OMN', type: 'EVNH', keywords: ['LUPITA NO PLANETA DE GENTE GRANDE', 'LUPITA'] },
  ...
  { code: '89795', descricao: 'VH A SEGUIR O CERRADO E OUTROS BICHOS',         tempo: '00:00:05', midia: '0OMN', type: 'EVNH', keywords: ['O CERRADO E OUTROS BICHOS', 'CERRADO E OUTROS BICHOS'] },
  ...
  { code: '89030', descricao: 'VH A SEGUIR AÇAO!',                             tempo: '00:00:05', midia: '0OMN', type: 'EVNH', keywords: ['ACAO', 'AÇÃO', 'AÇAO'] },
  { code: '85196', descricao: 'VH A SEGUIR CONTA A VIRADA',                    tempo: '00:00:05', midia: '0OMN', type: 'EVNH', keywords: ['CONTA A VIRADA'] },
  { code: '85242', descricao: 'VH A SEGUIR CONTA A VIRADA',                    tempo: '00:00:05', midia: '0OMN', type: 'EVNH', keywords: ['CONTA A VIRADA'] },
  { code: '85197', descricao: 'VH A SEGUIR ENTRELINHAS',                       tempo: '00:00:05', midia: '0OMN', type: 'EVNH', keywords: ['ENTRELINHAS'] },
  { code: '88970', descricao: 'VH A SEGUIR ESTUDIO CIENCIA',                   tempo: '00:00:05', midia: '0OMN', type: 'EVNH', keywords: ['ESTUDIO CIENCIA', 'ESTÚDIO CIÊNCIA'] },
  { code: '88968', descricao: 'VH A SEGUIR GAME DEV BRASIL',                   tempo: '00:00:05', midia: '0OMN', type: 'EVNH', keywords: ['GAME DEV BRASIL'] },
  { code: '90162', descricao: 'VH A SEGUIR HEROINAS NEGRAS BRASILEIRAS',       tempo: '00:00:05', midia: '0OMN', type: 'EVNH', keywords: ['HEROINAS NEGRAS BRASILEIRAS', 'HEROÍNAS NEGRAS BRASILEIRAS'] },
  ...
  { code: '88966', descricao: 'VH A SEGUIR MUTATIS MUTANDIS',                  tempo: '00:00:05', midia: '0OMN', type: 'EVNH', keywords: ['MUTATIS MUTANDIS'] },
  { code: '85200', descricao: 'VH A SEGUIR OLHA ELAS',                         tempo: '00:00:05', midia: '0OMN', type: 'EVNH', keywords: ['OLHA ELAS'] },
  { code: '85257', descricao: 'VH A SEGUIR OLHA ELAS',                         tempo: '00:00:05', midia: '0OMN', type: 'EVNH', keywords: ['OLHA ELAS'] },
  { code: '88967', descricao: 'VH A SEGUIR PORTUGUES DAQUI PORTUGUES DE LA',   tempo: '00:00:05', midia: '0OMN', type: 'EVNH', keywords: ['PORTUGUES DAQUI', 'PORTUGUÊS DAQUI'] },
  ...
  { code: '85204', descricao: 'VH A SEGUIR TRILHA DE LETRAS',                  tempo: '00:00:05', midia: '0OMN', type: 'EVNH', keywords: ['TRILHA DE LETRAS'] },
  { code: '85263', descricao: 'VH A SEGUIR TRILHA DE LETRAS',                  tempo: '00:00:05', midia: '0OMN', type: 'EVNH', keywords: ['TRILHA DE LETRAS'] },
  { code: '85205', descricao: 'VH A SEGUIR UNIVERCIENCIA',                     tempo: '00:00:05', midia: '0OMN', type: 'EVNH', keywords: ['UNIVERCIENCIA', 'UNIVERCIÊNCIA'] },
  { code: '90230', descricao: 'VH A SEGUIR BOLA PRA FRENTE',                   tempo: '00:00:05', midia: '0OMN', type: 'EVNH', keywords: ['BOLA PRA FRENTE'] },
  ...
  { code: '89792', descricao: 'VH A SEGUIR CRIANÇA DE RAIZ',                   tempo: '00:00:05', midia: '0OMN', type: 'EVNH', keywords: ['CRIANCA DE RAIZ', 'CRIANÇA DE RAIZ'] },
  { code: '85244', descricao: 'VH A SEGUIR CURTA DOC',                         tempo: '00:00:05', midia: '0OMN', type: 'EVNH', keywords: ['CURTA DOC'] },
  { code: '90362', descricao: 'VH A SEGUIR ESCOLA DE SABORES',                 tempo: '00:00:05', midia: '0OMN', type: 'EVNH', keywords: ['ESCOLA DE SABORES'] },
  { code: '88977', descricao: 'VH A SEGUIR ESTAÇOES',                          tempo: '00:00:05', midia: '0OMN', type: 'EVNH', keywords: ['ESTACOES', 'ESTAÇÕES'] },
  { code: '85246', descricao: 'VH A SEGUIR FAIXA CINE (reprise quarta 22h)',   tempo: '00:00:05', midia: '0OMN', type: 'EVNH', keywords: ['FAIXA CINE'] },
  { code: '85247', descricao: 'VH A SEGUIR FAROIS DO BRASIL',                  tempo: '00:00:05', midia: '0OMN', type: 'EVNH', keywords: ['FAROIS DO BRASIL', 'FARÓIS DO BRASIL'] },
  { code: '85250', descricao: 'VH A SEGUIR FORTES DO BRASIL',                  tempo: '00:00:05', midia: '0OMN', type: 'EVNH', keywords: ['FORTES DO BRASIL'] },
  { code: '85253', descricao: 'VH A SEGUIR MEU PEDAÇO DO BRASIL',              tempo: '00:00:05', midia: '0OMN', type: 'EVNH', keywords: ['MEU PEDACO DO BRASIL', 'MEU PEDAÇO DO BRASIL'] },
  { code: '85256', descricao: 'VH A SEGUIR NOSSOS BIOMAS',                     tempo: '00:00:05', midia: '0OMN', type: 'EVNH', keywords: ['NOSSOS BIOMAS'] },
  { code: '88323', descricao: 'VH A SEGUIR PARQUES DO BRASIL',                 tempo: '00:00:05', midia: '0OMN', type: 'EVNH', keywords: ['PARQUES DO BRASIL'] },
  { code: '90365', descricao: 'VH A SEGUIR PESQUISA EM CURSO',                 tempo: '00:00:05', midia: '0OMN', type: 'EVNH', keywords: ['PESQUISA EM CURSO'] },
  { code: '85261', descricao: 'VH A SEGUIR QUARTA CINE (Quarta 22h)',          tempo: '00:00:05', midia: '0OMN', type: 'EVNH', keywords: ['QUARTA CINE'] },
  { code: '89034', descricao: 'VH A SEGUIR SAL A GOSTO',                       tempo: '00:00:05', midia: '0OMN', type: 'EVNH', keywords: ['SAL A GOSTO'] },
  { code: '90359', descricao: 'VH A SEGUIR SCIENTIA',                          tempo: '00:00:05', midia: '0OMN', type: 'EVNH', keywords: ['SCIENTIA'] },
  { code: '85262', descricao: 'VH A SEGUIR SEMENTES DA EDUCACAO',              tempo: '00:00:05', midia: '0OMN', type: 'EVNH', keywords: ['SEMENTES DA EDUCACAO', 'SEMENTES DA EDUCAÇÃO'] },
  { code: '88974', descricao: 'VH A SEGUIR TEOPHILO OTTONI',                   tempo: '00:00:05', midia: '0OMN', type: 'EVNH', keywords: ['TEOPHILO OTTONI'] },
  { code: '90496', descricao: 'VH A SEGUIR TOCANDO A REAL',                    tempo: '00:00:05', midia: '0OMN', type: 'EVNH', keywords: ['TOCANDO A REAL'] },
];
...
const VH_ASSISTINDO_MAP = [
  ...
  { code: '89796', descricao: 'VH VC ESTA ASSISTINDO O CERRADO E OUTROS BICHOS',         tempo: '00:00:05', midia: '0OMN', type: 'EVNH', keywords: ['O CERRADO E OUTROS BICHOS', 'CERRADO E OUTROS BICHOS'] },
  { code: '88971', descricao: 'VH VC ESTA ASSISTINDO ESTÚDIO CIENCIA',                   tempo: '00:00:05', midia: '0OMN', type: 'EVNH', keywords: ['ESTUDIO CIENCIA', 'ESTÚDIO CIÊNCIA'] },
  { code: '88969', descricao: 'VH VC ESTA ASSISTINDO GAME DEV BRASIL',                   tempo: '00:00:05', midia: '0OMN', type: 'EVNH', keywords: ['GAME DEV BRASIL'] },
  ...
  { code: '85206', descricao: 'VH VC ESTA ASSISTINDO SE LIGA NA EDUCAÇÃO',               tempo: '00:00:05', midia: '0OMN', type: 'EVNH', keywords: ['SE LIGA NA EDUCACAO', 'SE LIGA NA EDUCAÇÃO'] },
  { code: '90233', descricao: 'VH VC ESTA ASSISTINDO BOLA PRA FRENTE',                   tempo: '00:00:05', midia: '0OMN', type: 'EVNH', keywords: ['BOLA PRA FRENTE'] },
  { code: '89037', descricao: 'VH VC ESTA ASSISTINDO CINCO MULHERES',                    tempo: '00:00:05', midia: '0OMN', type: 'EVNH', keywords: ['CINCO MULHERES'] },
  { code: '85267', descricao: 'VH VC ESTA ASSISTINDO CURTA DOC',                         tempo: '00:00:05', midia: '0OMN', type: 'EVNH', keywords: ['CURTA DOC'] },
  { code: '90363', descricao: 'VH VC ESTA ASSISTINDO ESCOLA DE SABORES',                 tempo: '00:00:05', midia: '0OMN', type: 'EVNH', keywords: ['ESCOLA DE SABORES'] },
  { code: '85268', descricao: 'VH VC ESTA ASSISTINDO FAIXA CINE (reprise quarta 22h)',   tempo: '00:00:05', midia: '0OMN', type: 'EVNH', keywords: ['FAIXA CINE'] },
  { code: '90366', descricao: 'VH VC ESTA ASSISTINDO PESQUISA EM CURSO',                 tempo: '00:00:05', midia: '0OMN', type: 'EVNH', keywords: ['PESQUISA EM CURSO'] },
  { code: '85271', descricao: 'VH VC ESTA ASSISTINDO QUARTA CINE (Quarta 22h)',          tempo: '00:00:05', midia: '0OMN', type: 'EVNH', keywords: ['QUARTA CINE'] },
  { code: '89035', descricao: 'VH VC ESTA ASSISTINDO SAL A GOSTO',                       tempo: '00:00:05', midia: '0OMN', type: 'EVNH', keywords: ['SAL A GOSTO'] },
  { code: '90360', descricao: 'VH VC ESTA ASSISTINDO SCIENTIA',                          tempo: '00:00:05', midia: '0OMN', type: 'EVNH', keywords: ['SCIENTIA'] },
  { code: '85272', descricao: 'VH VC ESTA ASSISTINDO SEMENTES DA EDUCACAO',              tempo: '00:00:05', midia: '0OMN', type: 'EVNH', keywords: ['SEMENTES DA EDUCACAO', 'SEMENTES DA EDUCAÇÃO'] },
  { code: '88975', descricao: 'VH VC ESTA ASSISTINDO TEOPHILO OTTONI',                   tempo: '00:00:05', midia: '0OMN', type: 'EVNH', keywords: ['TEOPHILO OTTONI'] },
];
